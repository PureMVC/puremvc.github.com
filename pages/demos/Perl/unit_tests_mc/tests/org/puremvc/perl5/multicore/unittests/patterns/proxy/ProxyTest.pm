package org::puremvc::perl5::multicore::unittests::patterns::proxy::ProxyTest;
...
BEGIN { use_ok( 'org::puremvc::perl5::multicore::patterns::proxy::Proxy' ); }
require_ok( 'org::puremvc::perl5::multicore::patterns::proxy::Proxy' );
...
sub testConstructor {
  ...
  my $proxy = org::puremvc::perl5::multicore::patterns::proxy::Proxy->new("ProxyTestName", 5);
  
  is(defined $proxy, 1, 'Expecting $proxy to be defined');
  isa_ok($proxy, 'org::puremvc::perl5::multicore::patterns::proxy::Proxy');
