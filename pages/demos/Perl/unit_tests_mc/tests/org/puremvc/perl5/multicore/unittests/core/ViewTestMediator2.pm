package org::puremvc::perl5::multicore::unittests::core::ViewTestMediator2;
...
use constant NAME => 'org::puremvc::perl5::multicore::unittests::core::ViewTestMediator2::name';
